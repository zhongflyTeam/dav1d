...
static inline int get_jnt_comp_ctx(const unsigned poc, const unsigned ref0poc,
                                   const unsigned ref1poc,
                                   const BlockContext *const a,
                                   const BlockContext *const l,
                                   const int yb4, const int xb4)
{
    const unsigned d0 = abs((int) ref0poc - (int) poc);
    const unsigned d1 = abs((int) ref1poc - (int) poc);
